...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String MA_THANH_VIEN_MTS = "ma_thanh_vien_mts";
    ...
    private static final String TAO_TABLE_MUON_TRA = ""
            ...
            + MA_THANH_VIEN_MTS + " INTEGER NOT NULL, "
            + NGAY_MUON_MTS + " TEXT, "
            + NGAY_TRA_MTS + " TEXT, "
            + "FOREIGN KEY (" + MA_SACH_MTS +")" + " REFERENCES " + TABLE_SACH + "(" + MA_SACH_S + "), "
            + "FOREIGN KEY (" + MA_MUON_TRA_MTS + ")" + " REFERENCES " + TABLE_THANH_VIEN + "(" + MA_THANH_VIEN_TV + "))";
    //TẠO BẢNG NHÂN VIÊN
